...
// should be X.Y : ie. if VERSION_DIGITALVALUE == 4, 7, 1, 0 , then X = 4, Y =
// 71 ex : #define VERSION_VALUE L"5.63\0"
...
#define INFO_URL L"https://github.com/northmendo/notepad-plus-plus"
#define FORCED_DOWNLOAD_DOMAIN                                                 \
  L"https://github.com/northmendo/notepad-plus-plus/"
...
#define INDICATOR_PLUGINS                                                      \
  9 // indicators 8 and below are reserved by Notepad++ (URL_INDIC=8)
#define INDICATOR_PLUGINS_LIMIT                                                \
  20 // indicators 21 and up are reserved by Notepad++
     // (SCE_UNIVERSAL_FOUND_STYLE_EXT5=21)
...
#define NPPM_INTERNAL_RELOADSCROLLTOEND                                        \
  (NOTEPADPLUS_USER_INTERNAL + 42) // Used by Monitoring feature
...
#define NPPM_INTERNAL_STOPMONITORING                                           \
  (NOTEPADPLUS_USER_INTERNAL + 49) // Used by Monitoring feature
...
#define NPPM_INTERNAL_SCINTILLAFINDERCOPYVERBATIM                              \
  (NOTEPADPLUS_USER_INTERNAL + 55)
...
#define NPPM_INTERNAL_LINECUTCOPYWITHOUTSELECTION                              \
  (NOTEPADPLUS_USER_INTERNAL + 78)
...
#define NPPM_INTERNAL_CHANGETOOLBARCOLORABLESTATE                              \
  (NOTEPADPLUS_USER_INTERNAL + 108)
...
#define NPPM_INTERNAL_SETTING_TABCOMPACTLABELLEN                               \
  (NOTEPADPLUS_USER_INTERNAL + 111)
...
//	#define WM_GETCURRENTMACROSTATUS (MACRO_USER + 01) // Replaced with
